/* jbdc/stubs/compat.h
 * Prefix header included in every translation unit via -include.
 * Defines private Apple constants missing from the Theos iPhoneOS16.5 SDK.
 */

#include <stdint.h>

/* ── CPU Family constants (Apple private, A16/A17/A18 era) ─────────────────── */
#ifndef CPUFAMILY_ARM_COLL
#define CPUFAMILY_ARM_COLL   0xda33d83f  /* A17 Pro */
#endif
#ifndef CPUFAMILY_ARM_IBIZA
#define CPUFAMILY_ARM_IBIZA  0x8765edea  /* A18     */
#endif
#ifndef CPUFAMILY_ARM_TUPAI
#define CPUFAMILY_ARM_TUPAI  0x11f8f3eb  /* A18 Pro */
#endif
#ifndef CPUFAMILY_ARM_DONAN
#define CPUFAMILY_ARM_DONAN  0x6fbaee70  /* A19?    */
#endif
#ifndef CPUFAMILY_ARM_HURRICANE
#define CPUFAMILY_ARM_HURRICANE 0x67ceee93 /* A10   */
#endif

/* ── KOFFSET enum & kgetoffset() for third_party darksword compatibility ──── */
typedef enum {
